...
<!-- PROJECT DESCRIPTION -->
 ...
 This project is about simple task test using jest.
...
```sh
  cd my-folder
  git clone https://github.com/supreeti/testing.git
```
### Install
...
Feel free to check the [issues page](https://github.com/supreeti/testing/issues/new).
...
This project is [MIT](https://github.com/supreeti/testing/blob/main/LICENSE) licensed.
<p align="right">(<a href="#readme-top">back to top</a>)</p>
